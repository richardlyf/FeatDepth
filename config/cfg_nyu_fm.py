...
data = dict(
    name = 'nyu_labeled',#dataset name
    split = 'nyu_labeled',#training split name
    height = HEIGHT,
    width = WIDTH,
    frame_ids = FRAME_IDS,
    in_path = '/home/jupyter/nyu_labeled',#path to raw data
    gt_depth_path = '/home/jupyter/nyu_labeled',#path to gt data
...
model = dict(
    ...
    max_depth = 10.0, # maximum of predicted depth value
    depth_pretrained_path = '/home/richardlinyf/FeatDepth/resnet{}.pth'.format(DEPTH_LAYERS),# pretrained weights for resnet
    pose_pretrained_path =  '/home/richardlinyf/FeatDepth/resnet{}.pth'.format(POSE_LAYERS),# pretrained weights for resnet
    extractor_pretrained_path = '/home/richardlinyf/monodepth2/autoencoder.pth',# pretrained weights for autoencoder
