...
from mono.datasets.nyu_dataset import NYULabeledDataset
...
if __name__ == "__main__":
    CFG_PATH = '../config/cfg_nyu_fm.py'#path to cfg file
    MODEL_PATH = '/home/richardlinyf/FeatDepth/NYU.pth'#path to model weights
